...
import { submitInquiry } from "@/lib/artworks";
...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Contact Ravitej for purchases, commissions, or studio inquiries." },
    ],
  }),
  component: Contact,
});
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-24 md:pt-32 pb-20 max-w-6xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
        <div className="lg:col-span-2">
          <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-8">— Get in touch</p>
          ...
          <div className="space-y-6 text-sm">
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground mb-1">Email</p>
              <a href="mailto:studio@ravitej.art" className="hover:text-foreground border-b border-border">
                studio@ravitej.art
              </a>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground mb-1">Response time</p>
              <p>Within 48 hours</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3">
          {sent ? (
            <div className="border border-border p-16 text-center bg-card/30">
              ...
              <p className="text-muted-foreground">Your message is in. I'll write back within 48 hours.</p>
            </div>
          ) : (
...
function Field({
  ...
  return (
    <div>
      <label className="text-xs uppercase tracking-[0.25em] text-muted-foreground mb-2 block">{label}</label>
      <input
        name={name}
        type={type}
